...
import 'competitioncomponent_model.dart';
export 'competitioncomponent_model.dart';

class CompetitioncomponentWidget extends StatefulWidget {
  const CompetitioncomponentWidget({
    super.key,
    this.parameter1,
    this.parameter2,
    this.parameter3,
...
class _CompetitioncomponentWidgetState extends State<CompetitioncomponentWidget>
  ...
  Widget build(BuildContext context) {
    return MouseRegion(
      ...
      onEnter: ((event) async {
        ...
        logFirebaseEvent('COMPETITIONCOMPONENT_MouseRegion_jtum1pk');
      ...
      child: InkWell(
        ...
        onTap: () async {
          logFirebaseEvent('COMPETITIONCOMPONENT_Container_est46rqq_');
                                  ...
                                  children: [
                                    ...
                                    Align(
                                      ...
                                      child: FlutterFlowIconButton(
                                        ...
                                        onPressed: () async {
                                          logFirebaseEvent(
                                              'COMPETITIONCOMPONENT_cartPlus_ICN_ON_TAP');
                                          if (loggedIn == false) {
                                            logFirebaseEvent(
