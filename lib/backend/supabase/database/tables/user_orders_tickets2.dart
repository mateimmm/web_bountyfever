...
class UserOrdersTickets2Table extends SupabaseTable<UserOrdersTickets2Row> {
  @override
  String get tableName => 'user_orders_tickets2';

  @override
  UserOrdersTickets2Row createRow(Map<String, dynamic> data) =>
      UserOrdersTickets2Row(data);
}

class UserOrdersTickets2Row extends SupabaseDataRow {
  UserOrdersTickets2Row(super.data);

  @override
  SupabaseTable get table => UserOrdersTickets2Table();
